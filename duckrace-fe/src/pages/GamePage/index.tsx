            ...
            <div className="absolute top-2 left-0 w-full flex justify-center items-center">
                ...
                >
                    ...
                    >
                        <img className="w-full h-full" src="/Window/SmallSubstrate.png"/>
                        <div
                            className=" items-center w-full py-1 px-3 text-[20px] font-titan text-white absolute top-2 left-1/2 transform -translate-x-1/2 ">
                            {gameStatus !== "waiting" &&
                                listDuckToShow?.map((player, index) => (
                                    ...
                                    >
                                        <div
                                            className="bg-[url('/Icons/StarIcon.png')] flex items-center justify-center bg-center bg-no-repeat bg-cover w-[35px] h-[35px]">
                                            {index + 1}
                                        </div>
